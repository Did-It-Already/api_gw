...
async function getUserId(token) {
	...
	const request$$1 = new Request('http://host.docker.internal:8000/api/auth/check', {
		method: 'GET',
	...
	const response = await fetch('http://host.docker.internal:8000/api/auth/check', request$$1);
	if (!response.ok) {
